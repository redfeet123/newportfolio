...
<main id="content" class="site-main">
    <section class="block-default px-50">
                ...
                <div class="<?php echo esc_attr($col_one); ?>">
                    <div class="block-default__inner mb-4">
                        ...
                        while ( have_posts() ) :
                            ...
                            if ( is_singular( 'post' ) ) {
                                $related_posts_label = get_theme_mod( 'jason_portfolio_resume_post_related_post_label', __( 'Related Posts', 'adinda-portfolio-resume' ) );
