...
(function($, api) {
   ...
   api.sectionConstructor['lyn-portfolio-upsell'] = api.Section.extend({
   ...
   const lyn_portfolio_section_lists = ['banner','skill','experience','gallery','blog','cta'];
   lyn_portfolio_section_lists.forEach(lyn_portfolio_homepage_scroll);

   function lyn_portfolio_homepage_scroll(item, index) {
        // Detect when the front page sections section is expanded (or closed) so we can adjust the preview accordingly.
        item = item.replace(/-/g, '_');
        wp.customize.section('lyn_portfolio_' + item + '_section', function(section) {
